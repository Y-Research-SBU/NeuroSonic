...
try:
    ...
    def _einops_missing(*_args, **_kwargs):
        raise ModuleNotFoundError(
            "Missing optional dependency 'einops'. Install it (pip install einops) "
            "to use rotary embedding utilities in neurosonic/utils/model_util.py."
        )
